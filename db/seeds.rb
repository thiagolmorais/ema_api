...
first_appointment = Appointment.create(start_time: Time.now, status: false, price: 150.00, customer_id: customer_a.id)
second_appointment = Appointment.create(start_time: Time.now-1.day, end_time: '2018-04-23T06:00:00.000Z', status: false, price: 150.00, customer_id: customer_a.id)
